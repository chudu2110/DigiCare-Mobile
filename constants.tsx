...
export const ICONS = {
  ...
  moodJournal: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-6 h-6"><rect x="6" y="3" width="12" height="18" rx="2" ry="2" strokeWidth="2"/><path d="M8 7h8" strokeWidth="2" strokeLinecap="round"/><path d="M8 11h8" strokeWidth="2" strokeLinecap="round"/><path d="M12 16c2 0 3-1 4-2" strokeWidth="2" strokeLinecap="round"/><path d="M10 16c-1 0-2-.5-3-1.5" strokeWidth="2" strokeLinecap="round"/><circle cx="10" cy="13" r=".75" fill="currentColor"/><circle cx="14" cy="13" r=".75" fill="currentColor"/></svg>,
  pen: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-6 h-6"><path d="M3 21l3.5-1 10-10a2 2 0 0 0 0-2.83l-.67-.67a2 2 0 0 0-2.83 0l-10 10L3 21z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><path d="M13.5 6.5l4 4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>,
};
